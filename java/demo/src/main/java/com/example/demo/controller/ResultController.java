...
public class ResultController {
    ...
    private void initialize() {
        correct = com.example.javafxdemo.controller.QuizPageController.correctAnswers;
        wrong = com.example.javafxdemo.controller.QuizPageController.incorrectAnswers;

        correcttext.setText("Correct Answers : " + correct);
        wrongtext.setText("Incorrect Answers : " + String.valueOf( com.example.javafxdemo.controller.QuizPageController.incorrectAnswers));
